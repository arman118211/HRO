...
export default function AboutSection() {
	...
	return (
		<section
			id="about"
			className="py-10 md:py-20 bg-gradient-to-br from-amber-50 to-yellow-50 relative overflow-hidden"
		>
			<div className="absolute top-0 left-0 w-64 h-64 bg-gradient-to-br from-yellow-400/10 to-transparent rounded-full blur-3xl"></div>
			<div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-amber-500/10 to-transparent rounded-full blur-3xl"></div>
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				<div className="text-center mb-16">
					...
					>
						...
						a diverse array of social, educational, and healthcare initiatives.
						The organization is steadfast in its mission to ensure access to
						quality education, support orphans and destitute children, empower
						youth through skills development, provide clean water, address
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
					{stats.map((stat, index) => (
						...
						>
							...
							{/* Floating sparkles */}
							<div className="absolute top-4 right-4 w-2 h-2 bg-yellow-500 rounded-full opacity-0 group-hover:opacity-100 animate-pulse transition-opacity duration-300"></div>
							...
							<div className="absolute inset-0 rounded-2xl border border-yellow-400/0 group-hover:border-yellow-400/20 transition-all duration-500"></div>
						</motion.div>
					))}
				</div>
