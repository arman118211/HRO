...
export default function Navbar() {
	...
	const causesDropdown = [
		...
		// { name: "In Kind Donation", href: "/causes/in-kind-gifts" },
		{
			...
			href: "/causes/skill-development",
		},
		{
			name: "Orphans & Destitute ",
			href: "/causes/orphans-destitute-children",
		},
				...
				<div className="flex justify-between items-center h-16">
						...
						<div className="relative">
							<div className=" w-15 h-15 rounded-full shadow-lg relative overflow-hidden">
								<img
									src="/logo.png"
									alt=""
									className="h-15 w-15 text-white relative z-10"
								/>
					...
					<div className="hidden lg:flex items-center space-x-1">
									...
									>
										{item.dropdown.map((dropItem) => (
											<Link
												...
												onClick={() => {
													trackEvent("navbar_dropdown_click", {
														item_name: dropItem.name,
														destination: dropItem.href,
													});
						...
						<Link
							...
							onClick={() =>
								trackEvent("navbar_donate_click", {
