...
const CareersPage = () => {
	const benefits = [
		{
			...
			description:
				"Make a real difference in communities and contribute to lasting social change.",
		...
		},
		{
			...
			description:
				"Access to training programs, conferences, and skill development opportunities.",
		...
		},
		{
			...
			description:
				"Work with passionate, like-minded individuals in a supportive environment.",
		...
		},
		{
			...
			description:
				"Flexible working arrangements and emphasis on personal well-being.",
		...
		},
		{
			...
			title: "Global Impact",
			description:
				"Opportunity to work on international projects and expand your worldview.",
	...
	const values = [
		...
		},
		{
			...
			title: "Innovation",
			description:
				"We embrace creative solutions to tackle complex social challenges.",
		},
		{
			icon: Users,
			title: "Collaboration",
			description:
				"We believe in the power of working together towards common goals.",
		},
		{
			icon: Target,
			title: "Impact",
	...
	const handleSubmit = async (e) => {
		...
		const templateParams = {
			...
			volunteerInterest: formData.position,
			availability: formData.experience,
		...
		<div className="min-h-screen bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 mt-0 md:mt-20 overflow-hidden">
			...
			>
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
					<div className="text-center">
						...
						>
							Be part of something bigger. Join our team of passionate
							changemakers and help us create
							<span className="text-yellow-600 font-bold">
								{" "}
								lasting impact
							</span>{" "}
							in communities around the Nepal.
						</motion.p>
			...
			>
				<div className="text-center mb-16">
					...
					<p className="text-xl text-gray-600 max-w-3xl mx-auto">
						Discover the benefits of joining a team that's committed to making a
						difference while investing in your growth.
					</p>
				</div>
					...
					{benefits.map((benefit, index) => (
						...
						>
							<div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 text-center border border-white/50 group-hover:shadow-2xl transition-all duration-500 h-full">
								<div
									className={`bg-gradient-to-r ${benefit.color} w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300`}
								>
			...
			>
				<div className="text-center mb-16">
					...
					<p className="text-xl text-gray-600 max-w-3xl mx-auto">
						Ready to make a difference? Fill out the form below and we'll get
						...
						<form className="space-y-8" onSubmit={handleSubmit}>
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
								<div>
									...
									>
										...
										<option value="senior-program-officer">
							...
							<div className="text-center pt-8">
								<motion.button
									type="submit"
									disabled={loading}
									className={`px-12 py-4 rounded-full font-bold text-xl transition-all duration-300 shadow-lg flex items-center mx-auto text-white ${
										loading
											? "bg-gray-400 cursor-not-allowed"
											: "bg-gradient-to-r from-yellow-400 to-amber-500 hover:from-yellow-500 hover:to-amber-600 hover:shadow-xl"
									}`}
			...
			<div className="bg-gradient-to-br from-yellow-50 to-amber-100 py-20">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-gray-600 max-w-3xl mx-auto">
							Our streamlined process ensures we find the right fit while
					...
					<div className="grid grid-cols-1 md:grid-cols-4 gap-8">
						{[
							...
							},
							{
								...
								description:
									"Our HR team reviews applications and shortlists candidates based on requirements.",
							},
							{
								step: "03",
								title: "Interview",
								description:
									"Selected candidates participate in video or in-person interviews with our team.",
							},
							{
								step: "04",
								title: "Join the Team",
								description:
									"Successful candidates receive an offer and begin their onboarding journey with us.",
							},
						].map((process, index) => (
							<motion.div
								key={index}
