...
export default function SponsorshipPage() {
	...
	return (
		<>
			<SEO
				title="Sponsorship Programs | Human Relief Organization Nepal"
				description="Sponsor education, clean water, healthcare, orphan support, winter relief, school transportation and community development programs across Nepal."
				keywords="sponsorship Nepal, sponsor child Nepal, sponsor school Nepal, charity Nepal, NGO sponsorship"
				url="https://hro.org.np/sponsorship"
			...
			<div className="min-h-screen bg-gradient-to-br from-white via-amber-50 to-yellow-50">
				...
				>
					<div className="max-w-6xl mx-auto text-center">
						...
						>
							Empower communities across Nepal. Choose a sponsorship program
							that resonates with your heart and be part of transformative
							change.
						</motion.p>
				...
				>
					<div className="bg-gradient-to-r from-amber-100 to-yellow-100 border-2 border-amber-300 rounded-2xl p-12">
						...
						<p className="text-gray-700 mb-8 text-lg leading-relaxed max-w-2xl mx-auto">
							Every contribution, no matter the size, transforms lives and
							builds hope in communities across Nepal. Your generosity today
							creates opportunities for tomorrow.
						</p>
						<motion.button
							whileHover={{ scale: 1.05 }}
							whileTap={{ scale: 0.95 }}
							onClick={() =>
								trackEvent("sponsorship_bottom_cta_click", {
									location: "bottom_cta",
								})
							}
