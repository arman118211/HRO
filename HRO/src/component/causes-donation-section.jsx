...
export default function CausesDonationSection() {
	...
	const goToPage = (page) => {
		trackEvent("causes_page_selected", {
			page_number: page + 1,
		});
		setCurrentPage(page);
	};
			...
			<div className="container mx-auto px-4 relative z-10">
				...
				>
					...
					<p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
						Choose a cause that resonates with your heart and make a direct
						impact on the lives of those who need it most. Every donation, no
								...
								<div className="mb-4">
									...
									<div className="flex justify-between items-center mt-2">
										...
										<span className="text-xs font-semibold text-yellow-600">
											{getProgressPercentage(cause.raised, cause.goal).toFixed(
												0,
											)}
											% funded
										</span>
