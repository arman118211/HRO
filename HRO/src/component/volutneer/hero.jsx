...
export default function Hero() {
	return (
		<>
			<SEO
				title="Volunteer With Us | Human Relief Organization Nepal"
				description="Become a volunteer with Human Relief Organization Nepal and help transform lives through education, healthcare, relief programs and community development."
				keywords="volunteer Nepal, NGO volunteer, charity volunteer, community service Nepal, Human Relief Organization"
				url="https://hro.org.np/volunteer"
				image="https://hro.org.np/volunteer.jpeg"
			/>
			<header className="relative isolate overflow-hidden bg-gradient-to-br from-white via-amber-50/30 to-yellow-50/50">
				...
				<div className="absolute inset-0 overflow-hidden pointer-events-none">
					...
					<div
						className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-l from-[#D4AF37]/5 to-amber-200/5 rounded-full blur-3xl animate-pulse"
						style={{ animationDelay: "1s" }}
					></div>
					<div
						className="absolute top-1/2 left-1/3 w-64 h-64 bg-gradient-to-br from-yellow-200/10 to-[#D4AF37]/10 rounded-full blur-2xl animate-pulse"
				...
				<div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
					<div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
						...
						>
							...
							>
								<HandHeart
									className="h-5 w-5 text-[#D4AF37] animate-pulse"
									aria-hidden="true"
								/>
							...
							>
								<span className="text-[#111827]">
									Turn compassion into action with a{" "}
								</span>
							...
							>
								Join a global community of change-makers. Give your time, share
								your skills, and help us empower lives with dignity and hope.
								Together, we create ripples of positive change that transform
								communities.
							</motion.p>
							...
							>
								<a
									href="#volunteer-form"
									onClick={() =>
										trackEvent("hero_volunteer_click", {
											section: "hero",
										})
									}
								...
								<a
									...
									onClick={() =>
										trackEvent("hero_how_it_works_click", {
											section: "hero",
										})
									}
								>
				...
				<svg
					className="absolute bottom-0 left-0 w-full h-16 text-[#D4AF37]/10"
