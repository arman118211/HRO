...
export default function ProgramsSection() {
	const programs = [
		...
		},
		{
			...
			description:
				"Providing nutritious meals and essential food support to children and vulnerable families.",
			image: "/slider7.png",
	...
	return (
		<>
			<SEO
				...
				description="Support education initiatives, healthcare access, clean water projects and nutrition programs across Nepal through Human Relief Organization Nepal."
				keywords="education Nepal, healthcare Nepal, clean water Nepal, nutrition program Nepal, NGO Nepal, charity Nepal"
				url="https://hro.org.np/"
				image="https://hro.org.np/logo.png"
			/>
			<section
				id="programs"
				className="py-20 bg-gradient-to-br from-amber-50 to-yellow-50/30 relative overflow-hidden"
			>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
					<div className="text-center mb-16">
						...
						>
							We focus on four key areas that create lasting change and
							sustainable development in communities of the Nepal.
						</motion.p>
					</div>
								...
								<div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-white/50 transform hover:scale-105 hover:-translate-y-2">
									...
									<div className="relative z-10">
										<div className="relative overflow-hidden">
											...
											<div
												className={`absolute top-6 left-6 bg-gradient-to-r ${program.color} p-4 rounded-xl shadow-lg`}
											>
										...
										<div className="p-8">
											...
											<div className="flex items-center justify-between">
												...
												<button
													onClick={() => {
														trackEvent("support_program_click", {
															program_id: program.id,
															program_name: program.title,
															page: window.location.pathname,
														});

														handleSupportClick(program);
													}}
