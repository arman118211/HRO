...
export default function DynamicCauses() {
	...
	const causesData = {
		education: {
			...
			programs: [
				...
				},
				{
					...
					description:
						"Comprehensive training programs for local educators with modern teaching methodologies",
				...
				},
				{
					...
					description:
						"Financial support for promising students to continue their education and achieve their dreams",
			...
			stories: [
				{
					...
					image:
						"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSM9pZ3UFdOVhRuxuYz2SDRST2Za_vwVNdM5A&s",
				...
				},
				{
					...
					location: "Nepal",
					story:
						"The mobile library brought books to our village. Now I read every day and want to become a teacher.",
					image:
						"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSM9pZ3UFdOVhRuxuYz2SDRST2Za_vwVNdM5A&s",
				...
				},
				{
					...
					location: "Nepal",
					story:
						"The computer lab at our school opened new possibilities. I'm learning coding and web development.",
					image:
						"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSM9pZ3UFdOVhRuxuYz2SDRST2Za_vwVNdM5A&s",
			...
			moreInfo: {
				...
				heroSubtitle:
					"Empowering Nepal’s children and communities through inclusive and quality learning.",
				...
				aboutImage: "/Education/School Funds.6.png",
				...
				impactPoints: [
					{
						...
						description:
							"Significant improvement in school attendance and learning.",
					},
					{
						icon: Globe,
						title: "Empowered Communities",
						description:
							"Education helps communities grow socially and economically.",
					},
					{
						icon: UserCheck,
				...
				impactImage: "/Education/School Funds.2.png",
		...
		healthcare: {
			...
			programs: [
				{
					title: "Medical Camp",
					description:
						"Providing free medical checkups, basic treatments, medications, and diagnostic services to underserved communities.",
				...
				},
				{
					...
					description:
						"Restoring vision for elderly and low-income individuals through free cataract screening and surgeries.",
				...
				},
				{
					...
					description:
						"Building local healthcare capacity through comprehensive training programs.",
			...
			moreInfo: {
				...
				aboutImage: "/HealthCare/HealthCare1.png",
				...
				objectives: [
					{
						...
						description:
							"Free checkups, diagnosis, and treatment in remote villages.",
					},
					{
						icon: Heart,
						title: "Maternal Care",
						description:
							"Safe motherhood, nutrition guidance, and newborn care.",
					},
					{
						icon: ShieldCheck,
						title: "Disease Prevention",
						description:
							"Awareness on hygiene, sanitation, and communicable diseases.",
					},
				],
				...
				programs: [
					{
						...
						description:
							"Bringing doctors and medications to remote communities.",
				...
				impactImage: "/HealthCare/Untitled design (6).png  ",
		...
		"skill-development": {
			...
			programs: [
				...
				},
				{
					...
					description:
						"Technology training for the modern workforce with comprehensive digital literacy programs",
				...
				},
				{
					...
					description:
						"Supporting small business creation and growth with comprehensive business training",
			...
			moreInfo: {
				...
				aboutImage: "/Skill Development/8.png",
				...
				impactImage: "/Skill Development/3.png",

				ctaTitle: "Support Skill Training",
				ctaDescription: "Your contribution helps families become self-reliant.",
				ctaDonateLink: "/donate",
				ctaVolunteerLink: "/volunteer",
			},
		},
		"water-for-life": {
			...
			moreInfo: {
				...
				aboutImage: "/Water 4 Life/5cd77c86-7edd-4eae-b8e1-a21f92150907.png",
				...
				objectives: [
					{
						...
						title: "Water Access",
						description:
							"Installing taps, wells, and gravity-fed water systems.",
					},
					{
						icon: Droplet,
				...
				programs: [
					...
					},
					{
						...
						description:
							"Handwashing stations and hygiene education in schools.",
				...
				impactPoints: [
					...
					},
					{
						...
						title: "Empowered Communities",
						description:
							"Water frees women and children from long-distance fetching.",
					},
				],

				impactImage: "/Water 4 Life/a41fd61a-a3c7-4f8b-baca-29ddb57eb612.png",
				...
				programs: [
					{
						...
						description:
							"Safe homes offering food, shelter, clothing, and love.",
		...
		"seasonal-programs": {
			...
			moreInfo: {
				...
				objectives: [
					{
						...
						title: "Winter Warmth",
						description:
							"Distribution of blankets, jackets, and heating supplies.",
					},
					{
						icon: Sun,
						title: "Summer Relief",
						description:
							"Drinking water, ORS, and shade tents in heat-affected areas.",
					},
					{
						icon: Gift,
						title: "Festival Support",
						description:
							"Food packs and clothing support during Dashain, Tihar, Eid.",
					},
				],
				...
				programs: [
					{
						...
						description:
							"Warm clothes, blankets, and heaters for high-altitude areas.",
				...
				impactImage: "/Seasionals/Picture3 (1).png",
		...
		"emergency-relief": {
			...
			moreInfo: {
				...
				aboutImage: "/Emergency Response/Nepal Earthquake10.JPG",
				...
				programs: [
					{
						...
						description:
							"Immediate support to families affected by seismic events.",
					...
					},
					{
						...
						description:
							"Food packs, shelter, and rescue efforts in monsoon-hit areas.",
						beneficiaries: "10,000+ individuals",
						duration: "Seasonal",
					},
					{
				...
				impactImage: "/Emergency Response/1 (1).png",
		...
		"nepal-fundraiser": {
			...
			subtitle: "Rapid Relief. Saving Lives. Rebuilding Hope.",
			description:
				"Responding to the devastating flash floods affecting communities across Nepal in 2026. Our emergency response provides immediate food, clean water, medical assistance, temporary shelter, hygiene supplies, and recovery support to families affected by flooding and landslides.",
			...
			impactStats: [
				...
				},
				{
					icon: Bandage,
					number: "3,000+",
					label: "People Receiving Medical Aid",
					color: "from-blue-500 to-indigo-600",
					bgColor: "bg-blue-500/10",
				},
				{
					icon: Home,
					number: "2,000+",
					label: "Families Receiving Shelter Support",
					color: "from-green-500 to-emerald-600",
					bgColor: "bg-green-500/10",
				},
			],
			...
			programs: [
				{
					title: "Emergency Food & Relief Kits",
					description:
						"Delivering essential food, clean drinking water, hygiene items, blankets, and other emergency supplies to families affected by the 2026 flash floods.",
					impact: "5,000+ families targeted for immediate support",
					cost: "$100 per family",
					icon: Package,
					gradient: "from-orange-400 to-orange-600",
					features: [
						...
						"Hygiene essentials",
						"Blankets & basic necessities",
					],
				},
				{
					title: "Emergency Medical Response",
					description:
						"Providing first aid, essential medicines, medical consultations, and mobile health support to flood-affected communities facing injuries, illness, and unsafe conditions.",
					impact: "3,000+ people targeted for medical assistance",
					cost: "$50 per person",
					icon: Bandage,
					gradient: "from-blue-500 to-indigo-600",
					features: [
				...
				{
					title: "Emergency Shelter & Family Support",
					description:
						"Supporting families whose homes have been damaged or destroyed with temporary shelter, bedding, tarpaulins, and essential household supplies.",
					impact: "2,000+ flood-affected families targeted",
					cost: "$250 per family",
					icon: Home,
					gradient: "from-green-500 to-emerald-600",
					features: [
			...
			stories: [
				{
					name: "Flood-Affected Family",
					age: 0,
					location: "Nepal",
					story:
						"When flash floods swept through their community, the family was forced to leave their home with little more than what they could carry. Emergency food, clean water, shelter materials, and essential supplies are helping them stay safe while they begin rebuilding their lives.",
					image:
						"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSM9pZ3UFdOVhRuxuYz2SDRST2Za_vwVNdM5A&s",
					achievement: "Received emergency relief and shelter support",
				},
				{
					name: "Flood Survivor",
					age: 0,
					location: "Nepal",
					story:
						"After severe flooding disrupted access to food and healthcare, emergency responders provided essential supplies and medical assistance. Continued support is helping the family recover with safety and dignity.",
					image:
						"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSM9pZ3UFdOVhRuxuYz2SDRST2Za_vwVNdM5A&s",
					achievement: "Received food, medical and emergency assistance",
				},
				{
					...
					location: "Nepal",
					story:
						"Floodwaters and landslides left families displaced and communities struggling to access basic necessities. Rapid relief efforts are helping provide food, clean water, temporary shelter, and support for recovery.",
					image:
						"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSM9pZ3UFdOVhRuxuYz2SDRST2Za_vwVNdM5A&s",
					achievement: "Community supported during flood recovery",
				},
			],

			bannerImage: [
				{
					src: "https://www.humanitariancoalition.ca/sites/default/files/styles/carousel_fallback/public/web%20banners%20%281920x640%29%20%2828%29.png?itok=uhcOTwNA",
					alt: "Nepal Flash Flood Emergency Response 2026",
					caption: "Emergency response for flood-affected communities in Nepal",
				},
				{
					src: "https://www.unicefusa.org/sites/default/files/styles/hero_width_scale_width_1400_/public/2026-08/UN0914878.jpg.webp?itok=GQX_ycx_",
					alt: "Flood Relief in Nepal",
					caption:
						"Delivering urgent relief to families affected by flash floods",
				},
				{
					src: "https://english.amarujaladigital.com/_next/image?url=https%3A%2F%2Fstaticimg.amarujala.com%2Fassets%2Fimages%2Fenglish.amarujaladigital.com%2F2026%2F09%2F02%2Fnepal-floods-aftermath_8479b25ac3b467082019583d8111beef.jpeg&w=828&q=50",
					alt: "Emergency Relief Distribution",
					caption:
						"Food, water and essential supplies reaching affected families",
				},
				{
					src: "https://foreignpolicy.com/wp-content/uploads/2026/09/nepal-floods-GettyImages-2292288106.jpg?quality=90",
					alt: "Nepal Flood Emergency",
					caption: "Supporting communities through the 2026 flood emergency",
				},
				{
					src: "https://th-i.thgim.com/public/incoming/6boxkk/article70128851.ece/alternates/FREE_1200/Nepal_Landslides_45562.jpg",
					alt: "Flood Recovery Nepal",
					caption: "Helping families recover and rebuild after the floods",
				},
			],
			...
			moreInfo: {
				...
				heroTitle: "Nepal Flash Flood Emergency Response – 2026",

				heroSubtitle:
					"Providing urgent food, clean water, medical aid, temporary shelter, and essential supplies to communities affected by the 2026 flash floods and landslides across Nepal.",

				heroCtaText: "Support Flood Relief",
				...
				stats: [
					...
					},
					{
						icon: MapPin,
						number: "20+",
						label: "Affected Communities Reached",
					},
				],

				aboutTitle: "About the Nepal Flash Flood Emergency Response – 2026",

				aboutDescription:
					"Severe flash floods and landslides have affected communities across Nepal in 2026, damaging homes, disrupting livelihoods, and limiting access to food, clean water, healthcare, and safe shelter. Our emergency response focuses on reaching affected families quickly with essential relief supplies, medical assistance, temporary shelter, and recovery support.",

				aboutImage:
					"https://images.ft.com/v3/image/raw/https%3A%2F%2Fd1e00ek4ebabms.cloudfront.net%2Fproduction%2Fde33d53e-b792-4e92-b219-07b7023687fb.jpg?source=next&fit=scale-down&dpr=2&width=340",

				missionTitle: "Our Mission",

				missionDescription:
					"To respond rapidly to the 2026 flash flood emergency, protect vulnerable families, provide essential humanitarian assistance, and help affected communities recover with safety, dignity, and hope.",
				...
				missionPoints: [
					...
					"Hygiene and sanitation assistance",
				...
				objectives: [
					{
						...
						description:
							"Delivering food, clean water, blankets, hygiene kits, tarpaulins, and other essential supplies to flood-affected families.",
					},
					{
						icon: Home,
						title: "Temporary Shelter",
						description:
							"Providing safe temporary accommodation and essential household items for families displaced or whose homes have been damaged.",
					},
					{
						icon: Bandage,
						title: "Medical & Health Support",
						description:
							"Providing first aid, essential medicines, medical consultations, and emergency health services in affected communities.",
					},
					{
						icon: ShieldCheck,
						title: "Protection & Safety",
						description:
							"Supporting vulnerable families with safe evacuation, emergency information, hygiene assistance, and protection from further risks.",
					},
				],
				...
				programs: [
					{
						...
						description:
							"Rapid deployment of emergency food, water, shelter materials, hygiene supplies, and other essential assistance to communities affected by flash floods.",
					...
					},
					{
						title: "Flood & Landslide Relief",
						description:
							"Supporting communities affected by flooding and landslides with relief distributions, emergency shelter, medical support, and essential household supplies.",
						beneficiaries: "5,000+ families",
						duration: "Emergency & recovery",
					},
					{
						title: "Early Recovery & Rehabilitation",
						description:
							"Helping affected families restore basic living conditions, replace essential household items, and begin rebuilding their homes and livelihoods.",
						beneficiaries: "2,000+ families",
						duration: "Post-emergency recovery",
					},
				],

				achievements: [
					"Emergency assistance delivered to flood-affected communities",
					"Food and clean water distributed to families in need",
					"Temporary shelter and essential household supplies provided",
					"Medical assistance made available to vulnerable communities",
					"Supporting families as they begin recovery after the floods",
				],

				testimonials: [
					{
						name: "Flood Survivor",
						role: "Flood-Affected Family",
						text: "The relief reached us when we needed it most. The food, water, and shelter support gave our family hope during a very difficult time.",
						rating: 5,
					},
					{
						name: "Relief Beneficiary",
						role: "Flood-Affected Community",
						text: "We lost many of our belongings in the flood. Receiving food, clean water, and essential supplies helped us get through those first difficult days.",
						rating: 5,
					},
					{
						name: "Community Member",
						role: "Flood-Affected Family",
						text: "The emergency team came when our community was struggling. Their support reminded us that we were not alone in this crisis.",
						rating: 5,
					},
					{
						name: "Medical Aid Beneficiary",
						role: "Flood-Affected Community",
						text: "Access to medical care and essential medicines was a great relief for our family. We are grateful for the support during such a difficult time.",
						rating: 5,
					},
					{
						name: "Shelter Beneficiary",
						role: "Displaced Family",
						text: "After our home was damaged by the floods, the temporary shelter gave our family a safe place to stay. It brought us comfort when everything felt uncertain.",
						rating: 5,
					},
					{
						name: "Relief Recipient",
						role: "Flood-Affected Community",
						text: "The food and clean water distribution made a real difference for our community. Every package brought a little more hope to families affected by the floods.",
						rating: 5,
					},
				],

				impactTitle: "Help Families Survive the 2026 Flood Emergency",

				impactDescription:
					"Every hour matters during a disaster. Your support helps us deliver food, clean water, medical care, emergency shelter, and essential supplies to families affected by flash floods and landslides in Nepal.",
				...
				impactPoints: [
					{
						...
						description:
							"Emergency shelter, food, water, and essential supplies help protect families during the crisis.",
					},
					{
						icon: Heart,
						title: "Hope Restored",
						description:
							"Timely humanitarian assistance helps affected families recover with dignity and begin rebuilding their lives.",
					},
					{
						icon: Users,
						title: "Community Recovery",
						description:
							"Supporting families and local communities as they move from emergency response toward recovery.",
					},
				],

				impactImage:
					"https://thaagam.org/static/website/assets/images/nee_m.webp",

				ctaTitle: "Help Us Respond to Nepal's Flood Emergency",

				ctaDescription:
					"Your contribution can help provide emergency food, clean water, medical care, temporary shelter, and essential supplies to families affected by the 2026 flash floods.",
	...
	const images = {
		...
		"nepal-fundraiser": [
			"https://dims.apnews.com/dims4/default/3655883/2147483647/strip/true/crop/8640x5757+0+1/resize/980x653!/quality/90/?url=https%3A%2F%2Fassets.apnews.com%2Fae%2Fd0%2F673c4d627527d81686a031b8a57a%2Feee66f5837b249a2a0d1d0d44cc859a1",
			"https://asianews.network/wp-content/uploads/bfi_thumb/thumb-2-7glhyog72k6ga5xe61q6j8cozmeh6uwwc7yupkuiwjk.jpg",
			"https://cdn.i-scmp.com/sites/default/files/styles/1020x680/public/d8/images/canvas/2024/09/28/03a8133b-7899-46ea-9487-5644133041a9_0b39ede6.jpg?itok=o656qjqo&v=1727513076",
			"https://images.donatekart.com/campaign/cover/Support-Flood-Survivors621255220.jpg",
		],
	};
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-amber-50 via-yellow-50/30 to-orange-50 mt-0 md:mt-9">
			<div className="h-[235px] md:h-[500px] md:mt-28 mt-18 mb-4  ">
				<ImageSlider images={currentCause.bannerImage} />
			</div>
							...
							<div className="text-center mb-16">
								...
								>
									...
									<p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
										...
										in communities in Nepal. Each program is carefully crafted
							...
							<div className="text-center mb-16">
								...
								>
									...
									<p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
										...
										These inspiring journeys show the power of opportunity and
										determination.
									</p>
								</motion.div>
							</div>
