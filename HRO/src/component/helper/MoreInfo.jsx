            ...
            >
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  >
                    <stat.icon style={{ color: colorScheme.primary }} size={32} />
                  </div>
      ...
      {aboutDescription && (
        <section className="py-20">
          <div className="container mx-auto px-6">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">{aboutTitle}</h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <motion.div
                ...
                className="space-y-6"
              >
                <h3 className="text-3xl font-bold text-gray-800">{missionTitle}</h3>
                ...
                <div className="space-y-4">
                  {missionPoints.map((point, index) => (
                    <div key={index} className="flex items-center gap-3">
                      <CheckCircle style={{ color: colorScheme.primary }} size={24} />
      ...
      {objectives.length > 0 && (
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-6">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">Our Objectives</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                We work towards specific, measurable goals that create lasting impact
              </p>
            </motion.div>
              ...
              {objectives.map((objective, index) => (
                ...
                >
                  <div 
                    ...
                    style={{ backgroundColor: `${colorScheme.primary}20` }}
                  >
                    <objective.icon style={{ color: colorScheme.primary }} size={32} />
                  </div>
                ...
                >
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-gray-700 font-medium">{program.beneficiaries}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Calendar style={{ color: colorScheme.primary }} size={20} />
                ...
                >
                  <div className="flex gap-1 mb-4">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star key={i} style={{ color: colorScheme.primary }} className="fill-current" size={20} />
                    ))}
                  </div>
                  <p className="text-gray-600 mb-6 leading-relaxed italic">"{testimonial.text}"</p>
                  <div>
                    <h4 className="font-bold text-gray-800">{testimonial.name}</h4>
                    <p className="font-medium" style={{ color: colorScheme.primary }}>{testimonial.role}</p>
                  </div>
                </motion.div>
              ))}
            </motion.div>
          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <motion.div
                ...
                transition={{ duration: 0.6 }}
              >
                <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">{impactTitle}</h2>
                  ...
                  {impactPoints.map((point, index) => (
                    <div key={index} className="flex items-center gap-4">
                      <div 
                        ...
                        style={{ backgroundColor: `${colorScheme.primary}20` }}
                      >
                        <point.icon style={{ color: colorScheme.primary }} size={24} />
                      </div>
                      <div>
...
const EducationPage = () => {
  return (
        ...
        objectives={[
            ...
            description: "Providing access to quality education for underprivileged children in rural and urban areas.",
            },
            {
            icon: Users,
            title: "Teacher Training",
            description: "Training and supporting teachers with modern teaching methodologies and resources.",
            },
            {
            icon: Lightbulb,
            title: "Digital Literacy",
            description: "Introducing digital learning tools and computer literacy programs.",
            },
            {
            icon: Heart,
            title: "Holistic Development",
            description: "Focusing on overall personality development including life skills and values.",
            },
        ]}
        ...
        programs={[
            ...
            description: "Supporting children aged 6-12 with basic education, learning materials, and nutritional support.",
            beneficiaries: "2,500+ children",
            duration: "Ongoing since 2018",
            },
            {
            title: "Adult Literacy Program",
            description: "Teaching reading, writing, and basic mathematics to adults who missed formal education.",
            beneficiaries: "1,200+ adults",
            duration: "Evening classes",
            },
            {
            title: "Scholarship Program",
            description: "Providing financial assistance to meritorious students from economically weak backgrounds.",
            beneficiaries: "500+ students",
            duration: "Annual program",
            },
            {
            title: "Digital Learning Centers",
            description: "Setting up computer labs and digital learning facilities in rural schools.",
