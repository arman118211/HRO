...
const AboutPage = () => {
	...
	const values = [
		...
		},
		{
			icon: Target,
			title: "Self - Respect",
			description: "To help the poor without the feeling of humiliation.",
		},
		{
			icon: Globe,
	...
	return (
		<>
			<SEO
				title="About Us | Human Relief Organization Nepal"
				description="Learn about Human Relief Organization Nepal, our mission, vision, values, programs, executive team, partners, and community impact across Nepal."
				keywords="about HRO Nepal, NGO Nepal, charity Nepal, humanitarian organization Nepal, volunteer Nepal"
				url="https://hro.org.np/about"
				...
				<div className="relative bg-gradient-to-r from-[#2979FF] to-green-600 text-white py-9 px-4 md:py-12 overflow-hidden">
					...
					<div className="relative max-w-5xl mx-auto text-center">
						...
						<p className="text-lg md:text-xl mb-6 text-blue-100 max-w-3xl mx-auto leading-relaxed">
							Creating lasting positive change in underserved communities
					...
					<div className="max-w-6xl mx-auto">
						<div className="text-center mb-12">
							...
							<p className="text-lg text-gray-600 max-w-3xl mx-auto">
								Everything we do is guided by our core mission, vision, and
								values that have shaped our organization since day one.
							</p>
						</div>
						...
						<div className="bg-white rounded-3xl shadow-xl p-8 border border-blue-100">
							...
							{activeTab === "vision" && (
								<div className="text-center">
									...
									<p className="text-lg text-gray-600 leading-relaxed max-w-4xl mx-auto">
										As a leader to empower lives, creating opportunities and
										strengthen the bond of humanity.
									</p>
								</div>
							)}
						...
						<div className="relative">
							...
							<div className="space-y-12">
								{milestones.map((milestone, index) => (
									...
									>
										<div
											className={`w-1/2 ${index % 2 === 0 ? "pr-4" : "pl-4"}`}
										>
				...
				<div className="py-16 px-4">
					<div className="max-w-6xl mx-auto">
						<div className="text-center mb-12">
							...
							<p className="text-lg text-gray-600 max-w-3xl mx-auto">
								Our commitment to excellence and transparency has been
								recognized by leading organizations Nepal.
							</p>
						</div>
				...
				<div className="bg-gradient-to-r from-[#2979FF] to-green-600 py-16 px-4">
					<div className="max-w-4xl mx-auto text-center text-white">
						...
						<p className="text-xl mb-8 opacity-90">
							Together, we can create lasting change and build a better Nepal
