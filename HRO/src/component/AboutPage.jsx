...
const AboutPage = () => {
  ...
  const stats = [
    ...
    { icon: Globe, label: "Districts Reached", value: "8+", color: "text-green-600" },
  ...
  const programs = [
    ...
    },
    {
      ...
      description: "Building employable skills and supporting long-term livelihood development for families in need.",
    ...
    },
    {
      ...
      description: "Providing care, protection, and essentials for orphaned and vulnerable children.",
    ...
    },
    {
      ...
      description: "Helping communities through seasonal support including food packs, warm clothing, and festival aid.",
    ...
    },
    {
      ...
      description: "Ensuring access to clean drinking water through wells, filtration systems, and water distribution.",
  ...
  const nextExecutiveSlide = () => {
    ...
    setCurrentExecutiveSlide(Math.min(maxSlide, currentExecutiveSlide + increment));
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 mt-12 md:mt-25">
      ...
      <div className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Our Organization</h2>
      ...
      <div className="bg-gray-50 py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Executive Team</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="hidden md:block">
              <div className="grid md:grid-cols-3 gap-8">
                {teamMembers.slice(currentExecutiveSlide, currentExecutiveSlide + 3).map((member, index) => (
            ...
            <div className="md:hidden">
              <div className="max-w-sm mx-auto">
                {teamMembers.slice(currentExecutiveSlide, currentExecutiveSlide + 1).map((member, index) => (
            ...
            <button
              ...
              disabled={currentExecutiveSlide >= teamMembers.length - (window.innerWidth >= 768 ? 3 : 1)}
            ...
            <div className="flex justify-center mt-8 space-x-2">
              {Array.from({ length: Math.ceil(teamMembers.length / (window.innerWidth >= 768 ? 3 : 1)) }).map((_, index) => (
                <button
                  key={index}
                  onClick={() => setCurrentExecutiveSlide(index * (window.innerWidth >= 768 ? 3 : 1))}
                  className={`w-3 h-3 rounded-full transition-colors ${
                    Math.floor(currentExecutiveSlide / (window.innerWidth >= 768 ? 3 : 1)) === index
                      ? 'bg-[#2979FF]'
      ...
      <div className="bg-gray-50 py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="hidden md:block">
              <div className="grid md:grid-cols-3 gap-8">
                {teams.slice(currentTeamSlide, currentTeamSlide + 3).map((member, index) => (
                  <div key={index} className="bg-white rounded-3xl shadow-xl p-6 text-center border border-blue-100 hover:shadow-2xl transition-all duration-300 group">
                    <div className="relative mb-6">
                      <img 
                        src={member.image} 
            ...
            <div className="md:hidden">
              <div className="max-w-sm mx-auto">
                {teams.slice(currentTeamSlide, currentTeamSlide + 1).map((member, index) => (
                  <div key={index} className="bg-white rounded-3xl shadow-xl p-6 text-center border border-blue-100">
                    <div className="relative mb-6">
                      <img 
                        src={member.image} 
            ...
            <button
              ...
              disabled={currentTeamSlide >= teams.length - (window.innerWidth >= 768 ? 3 : 1)}
              className="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-4 bg-white rounded-full p-3 shadow-lg border border-gray-200 hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <ChevronRight className="w-6 h-6 text-gray-600" />
            </button>
            ...
            <div className="flex justify-center mt-8 space-x-2">
              {Array.from({ length: Math.ceil(teams.length / (window.innerWidth >= 768 ? 3 : 1)) }).map((_, index) => (
                <button
                  key={index}
            ...
            {partners.map((partner, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg border border-blue-100 flex items-center space-x-4">
                <div className="bg-blue-100 p-3 rounded-lg">
                  ...
                  <img className="w-6 h-6" src={partner.logo} alt={partner.name}/>
      ...
      <div className="bg-gradient-to-r from-[#2979FF] to-green-600 py-16 px-4">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-xl mb-8 opacity-90">
            Together, we can create lasting change and build a better Nepal for future generations.
          </p>
