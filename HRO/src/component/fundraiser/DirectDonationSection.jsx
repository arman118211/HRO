...
const PayPalIcon = () => (
  <div className="w-5 h-5 rounded-md bg-[#003087] text-white flex items-center justify-center font-bold text-xs shadow-sm">
    P
  </div>
);
  ...
  return (
    <section className="w-full py-20 bg-slate-50/60 border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 2. INSTANT QR CODE PAYMENTS (NEPAL, INDIA & GLOBAL PAYPAL) */}
        <div className="mb-16">
          <div className="flex items-center justify-center gap-2 mb-8">
            <Smartphone className="w-5 h-5 text-amber-600" />
            <h3 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight">
              Instant Scan & Pay (Mobile Banking, UPI & PayPal)
            </h3>
          </div>

          {/* 3 cards across desktop / tablet */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            {/* 1. Nepal FonePay QR */}
            <div className="bg-white rounded-3xl border border-slate-200 p-6 sm:p-7 shadow-sm flex flex-col justify-between hover:border-amber-300 transition-all">
              <div>
                ...
                <div className="flex flex-col items-center mb-5">
                  <div className="w-40 h-40 rounded-2xl bg-white border-2 border-slate-100 p-2.5 shadow-sm flex items-center justify-center mb-4">
                    <img
                      src="/fonepay.png"
                  ...
                  <div className="space-y-2.5 w-full text-center">
                    ...
                    <div>
                      ...
                      <div className="flex items-center justify-center gap-1.5 pt-0.5">
                        <span className="font-mono text-[11px] font-bold text-slate-800 bg-slate-100 px-2 py-0.5 rounded-md truncate max-w-[160px]">
                          2222440017725843
                        </span>
                        <button
              ...
              <div className="pt-3 border-t border-slate-100 text-center">
                <span className="text-[10px] text-slate-500 font-medium leading-tight block">
                  Supported: eSewa, Khalti, IME Pay, Global Smart Plus & FonePay apps.
                </span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-200 p-6 sm:p-7 shadow-sm flex flex-col justify-between hover:border-amber-300 transition-all">
                ...
                <div className="flex flex-col items-center mb-5">
                  ...
                  <div className="space-y-2.5 w-full text-center">
                    ...
                    <div>
                      ...
                      <div className="flex items-center justify-center gap-1.5 pt-0.5">
                        <span className="font-mono text-[11px] font-bold text-amber-900 bg-amber-50 border border-amber-200 px-2 py-0.5 rounded-md truncate max-w-[160px]">
                          Pos.11425557@indus
                        </span>
                        <button
              ...
              <div className="pt-3 border-t border-slate-100 text-center">
                <span className="text-[10px] text-slate-500 font-medium leading-tight block">
                  Supported: Google Pay, PhonePe, Paytm, BHIM UPI & all Indian banking apps.
                </span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-200 p-6 sm:p-7 shadow-sm flex flex-col justify-between hover:border-amber-300 transition-all">
                ...
                <div className="flex flex-col items-center mb-5">
                  ...
                  <div className="space-y-2.5 w-full text-center">
                    ...
                    {/* <div>
                      ...
                      <div className="flex items-center justify-center gap-1.5 pt-0.5">
                        <span className="font-mono text-[11px] font-bold text-blue-950 bg-blue-50 border border-blue-200 px-2 py-0.5 rounded-md truncate max-w-[160px]">
                          paypal.me/hrononprofit
                        </span>
                        <button
                          onClick={() => handleCopy("https://paypal.me/hrononprofit", "paypal-qr")}
                          className="p-1 rounded-md hover:bg-slate-100 text-slate-500 hover:text-slate-800 transition-colors"
                          title="Copy PayPal URL"
                        >
                          {copiedKey === "paypal-qr" ? (
                            <Check className="w-3.5 h-3.5 text-emerald-600" />
                          ) : (
              ...
              <div className="pt-3 border-t border-slate-100 text-center">
                <span className="text-[10px] text-slate-500 font-medium leading-tight block">
                  Scan using camera or PayPal App to donate directly with PayPal balance or cards.
                </span>
              </div>
            </div>
          </div>
