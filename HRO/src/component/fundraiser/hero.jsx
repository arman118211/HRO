				...
				<div className="grid items-center gap-10 py-12 md:grid-cols-2 md:py-16">
					...
					>
						...
						<p className="text-sm leading-relaxed text-amber-700/80 sm:text-base font-medium">
							Support verified campaigns and track real-world impact. Your
							donation goes where it&apos;s needed most— directly to
							communities, with full accountability at every step.
						</p>
						...
						<div className="flex flex-col gap-3 sm:flex-row sm:items-center">
							...
							<a
								href="#campaigns"
								className="inline-flex items-center justify-center gap-2 rounded-lg border-2 border-yellow-500 bg-yellow-50 px-6 py-3 text-sm font-bold text-amber-800 transition-all duration-200 hover:bg-yellow-100 hover:border-yellow-600 hover:scale-105"
							>
								Explore Campaigns
							</a>
						</div>
						...
						<div className="relative aspect-[4/3] overflow-hidden rounded-xl shadow-2xl shadow-yellow-500/30">
							...
							<div className="absolute inset-x-4 bottom-4 rounded-lg border-2 border-yellow-400/60 bg-gradient-to-r from-yellow-50/95 to-amber-50/95 p-4 text-xs font-semibold text-amber-800 backdrop-blur-sm shadow-lg shadow-yellow-400/20">
								<div className="flex items-center gap-2">
									...
									Every donation is tracked with photo and report updates from
									the field.
								</div>
							</div>
						</div>
